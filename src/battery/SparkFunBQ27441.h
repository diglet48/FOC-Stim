...
public:
	...
	*/
	...
	/**
	 	Get battery insert enable
	 */
	bool BatteryInsertEnable();

	/**
	    Enable or disable battery detection with BIN pin.
		
		@param enable true to enable battery detection with BIN pin
		@return true on success
	*/
	bool setBatteryInsertEnable(bool enable);
